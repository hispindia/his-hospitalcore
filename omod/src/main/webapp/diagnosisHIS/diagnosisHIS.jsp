...
<openmrs:require privilege="Manage department" otherwise="/login.htm" redirect="/module/hospitalcore/diagnosisHIS.form" />
...
<h2><spring:message code="hospitalcore.download.excel"/></h2>	
...
function viewReport() {
	...
	jQuery.ajax({
					type : "GET",
					url : getContextPath() + "/module/hospitalcore/patientDiagnosisReport.form",
					data : ({
...
var tableToExcel = (function() {
	  ...
	  return function(table, name) {
	    ...
	    var ctx = {worksheet: 'OPDDiagnosisReport', table: table.innerHTML}
	   
		link.href = uri + base64(format(template, ctx));

		link.style = 'visibility:hidden';
		link.download ='DiagnossiReport.xls';
