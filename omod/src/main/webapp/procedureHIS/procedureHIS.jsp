...
<openmrs:require privilege="Manage department" otherwise="/login.htm" redirect="/module/hospitalcore/procedureHIS.form" />
...
function viewReport() {
	...
	jQuery.ajax({
					type : "GET",
					url : getContextPath() + "/module/hospitalcore/patientProcedureReport.form",
					data : ({
...
var tableToExcel = (function() {
	  ...
	  return function(table, name) {
		...
		link.download ='ProcedureReport.xls';
